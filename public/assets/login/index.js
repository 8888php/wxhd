	$(".icon_drop-down").click(function(){
			 if($(".div_display").css("display")=="none"){
               	...
               	$(".icon_drop-down").css({'background-image':'url(/assets/login/icon_drop-down.png)'});
               }else{
               	$(".div_display").css("display","none");
               	$(".icon_drop-down").css({'background-image':'url(/assets/login/icon_drop-down02.png)'});
               }
       });
...
$(".the_eyes").click(function(){
       	     if($("#password").attr('type') == 'password'){
       	     	...
       	     	$(".the_eyes").css({'background-image':'url(/assets/login/icon_open_eyes.png)'});
       	     }else{
       	     	$("#password").attr('type','password');
       	     	$(".the_eyes").css({'background-image':'url(/assets/login/icon_close_eyes.png)'});
       	     }
       });